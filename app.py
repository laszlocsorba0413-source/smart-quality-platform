...
Tükröződés megszüntetése CSS segítségével

custom_css = """
div[data-testid="image"] video,
div[data-testid="image"] img {
transform: scaleX(1) !important;
}
"""

with gr.Blocks(title="Smart Quality Platform - Csorba László", theme=custom_theme, css=custom_css) as demo:
gr.HTML("""

🛡️ Smart Quality Decision Platform
Enterprise AI Complaint Decisioning • Auto-Routing to Production & Warehouse
